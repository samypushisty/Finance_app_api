...
Revision ID: 6dfa4948449d
Revises: 
Create Date: 2024-12-08 20:51:41.342746
...
def upgrade() -> None:
    ...
    op.create_foreign_key(op.f('fk_category_chat_id_user'), 'category', 'user', ['chat_id'], ['chat_id'], ondelete='CASCADE')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(op.f('fk_category_chat_id_user'), 'category', type_='foreignkey')
